...
// Keeps every possible game payout inside the database per-transaction cap.
export const MAX_BET_AMOUNT = 1000
export const MAX_ROULETTE_TOTAL_BET = 1000

export const VALID_ROULETTE_SPOTS = new Set([
